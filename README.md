...
Project: WordPress WooCommerce Data Migration 
- Migrated Woocommerce product data between WordPress websites using phpMyAdmin (MySQL).
- Preserved product information, categories, attributes, images and Yoast SEO metadata during migration.
- Managed WordPress database operations using phpMyAdmin and Hostinger hPanel.
- Troubleshot WordPress migration issues including database conflicts, plugin compatibility and Elementorrelated errors.
...
### 🏅 Awards
- Award on achieving A-one Grade - Programmer School (2018)
